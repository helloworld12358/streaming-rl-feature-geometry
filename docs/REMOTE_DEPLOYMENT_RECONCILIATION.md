...
- 修复 commit `957784d8d40df6d61bd430307e554635ba18df88` 的 Ubuntu run `29633542079` 为 `success`，真实 `bash -n`、全部 remote dry-run、pytest、CI smoke、结果验证与 artifact upload 均通过；
